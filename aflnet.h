...
unsigned int* extract_response_codes_mqtt_client(unsigned char* buf, unsigned int buf_size, unsigned int* state_count_ref);
...
unsigned int* extract_response_codes_ethernet(unsigned char* buf, unsigned int buf_size, unsigned int* state_count_ref);
...
region_t* extract_requests_mqtt_client(unsigned char* buf, unsigned int buf_size, unsigned int* region_count_ref);
...
region_t* extract_requests_ethernet(unsigned char* buf, unsigned int buf_size, unsigned int* region_count_ref);
